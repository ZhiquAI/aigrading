...
export const RecordsPanel = ({ questionKey, examId, examName, latestGrading }: RecordsPanelProps) => {
  ...
  const loadRecords = async (pageOverride?: number): Promise<void> => {
    ...
    try {
      ...
      setRecordsData(data);
      rootStoreActions.setRecordSnapshot({
  ...
  return (
    <section className="card card-wide">
      ...
      <div className="field-row">
        ...
        <div className="field-group">
          <label htmlFor="records-filter-question-key">筛选题目标识（questionKey）</label>
          <input
        ...
        <div className="field-group">
          <label htmlFor="records-filter-question-no">筛选题号（questionNo）</label>
          <input
      ...
      <div className="field-row">
        ...
        <div className="field-group">
          <label htmlFor="records-question-no">题号（questionNo）</label>
          <input
      ...
      <div className="field-group">
        <label htmlFor="records-breakdown">评分拆解（breakdown，JSON 或文本）</label>
        <textarea
